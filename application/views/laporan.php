...
<html>
    <head>
        ...
        <title><?php echo $pageTitle; ?> | Kepegawaian Diskominfo Riau</title>
        <!-- CSS -->
        <style type="text/css">
            table {
                width: 100%;
    ...
    <body>        
        ...
        Nominatif Kenaikan Gaji Berkala tahun <?php $skrg = date("Y-m-d"); $date=date_create("$skrg"); echo $nominatif = date_format($date,"Y"); ?>
        <table>    
            <thead>
                <tr>
                    <th>No</th>
        ...
        <br/><br/>
        Pegawai yang melakukan Kenaikan Gaji Berkala tahun <?php $skrg = date("Y-m-d"); $date=date_create("$skrg"); echo $nominatif = date_format($date,"Y"); ?>
        <table>    
            <thead>
                <tr>
                    <th>No</th>
