...
<html lang="en">
<head>
	<title>Masuk | Kepegawaian Diskominfo</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?php echo site_url('assets/images/a.png') ?>" >
						<img src="<?php echo site_url('assets/images/homeland.png') ?>" >
				</div>
				
				<form class="login100-form validate-form" id="login-form" method="post" action="<?php echo base_url('auth/login'); ?>">
					<span class="login100-form-title">
						Kepegawaian Diskominfo Riau
					</span>
